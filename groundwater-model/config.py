...
# print(os.path.join("..", "bin", "mf6" + eext))
mf6_exe = "mf6" + eext
libmf6_exe = "libmf6" + soext
mf2005_exe = "mf2005" + eext
mf2005dbl_exe = "mf2005dbl" + eext
mfnwt_exe = "mfnwt" + eext
mt3dms_exe = "mt3dms" + eext
mt3dusgs_exe = "mt3dusgs" + eext
